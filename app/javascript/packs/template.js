...
const addCare = () => $("#btn-care-add").on("click", function () {
	...
	window
		...
		.then((res) => res.json())
		.then((response) => {
			let boxContentCare = $("#box-content-care").html(`<div id="btn-care-remove" data-host="${hostId}" data-care="${response.id}" data-user="${response.user_id}" data-house="${response.house_id}" class="btn btn-danger">
...
const removeCare = () => $("#btn-care-remove").on("click", function () {
	...
	window
		...
		.then((res) => res.json())
		.then((response) => {
			let boxContentCare = $("#box-content-care").html(`<div id="btn-care-add" data-host="${hostId}" data-user="${userId}" data-house="${houseId}" class="btn btn-primary">
